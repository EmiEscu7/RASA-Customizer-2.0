# RASA Customizer 2.0 Independient
### Objetivo:
...
#### Librerias necesarias:
	Version adaptada que no utiliza librerias.
#### Su uso:
...
El output a este request.post serÃ¡ el texto plano listo para ser formateado en python.
